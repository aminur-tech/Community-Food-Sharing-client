      ...
      <div className="navbar-end space-x-3">
        {user ? (
          <div className="dropdown dropdown-end">
            ...
            >
              <li>
                <Link to="/add-food" className="hover:bg-orange-50 hover:text-orange-600 transition-colors">
                  Add Food
                </Link>
              </li>
              <li>
                <Link to="/manage-foods" className="hover:bg-orange-50 hover:text-orange-600 transition-colors">
                  Manage My Foods
                </Link>
              </li>
              <li>
                <Link to="/my-requests" className="hover:bg-orange-50 hover:text-orange-600 transition-colors">
                  My Food Requests
                </Link>
              </li>
